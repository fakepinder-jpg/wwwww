...
export interface ApiBoardBoard extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tableau Kanban contenant des listes';
    displayName: 'Board';
    pluralName: 'boards';
    singularName: 'board';
  };
...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Cartes de t\u00E2ches dans les listes Kanban';
    displayName: 'Card';
    pluralName: 'cards';
    singularName: 'card';
  };
  ...
  attributes: {
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Nouvelle carte'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLabelLabel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u00C9tiquettes pour cat\u00E9goriser les cartes';
    displayName: 'Label';
    pluralName: 'labels';
    singularName: 'label';
  };
  ...
  attributes: {
    ...
    color: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'#808080'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiListList extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Colonnes Kanban contenant des cartes';
    displayName: 'List';
    pluralName: 'lists';
    singularName: 'list';
  };
  ...
  attributes: {
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Nouvelle liste'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
